...
### Notes for Reviewers
```
This is a rental booking app for apartments in Nigeria. Users can browse listings, book apartments, and make secure payments. A demo account is provided for testing purposes. The app uses Flutterwave for payment processing.
```

## Privacy Policy Template

You'll need a privacy policy URL. Here's a template you can use:

**Create a privacy policy page** with this content:

```
Privacy Policy for Apartify Africa
...
- Photos (for profile and property listings)
...
3. Data Sharing
- We share payment information with Flutterwave for payment processing
...
6. Contact Us
Email: support@apartifyafrica.com
```

Host this on a publicly accessible URL (your website, GitHub Pages, etc.)

## App Category

**Primary Category:** Travel or Lifestyle

**Secondary Category (optional):** Business or Utilities

## Age Rating

The app will be rated based on content. Since it's a booking app:
